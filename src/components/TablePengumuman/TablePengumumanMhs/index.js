...
import { CellAksiPengumuman, CellAksiPengumumanMahasiswa } from '../..';
...
export default class TablePengumumanMhs extends Component {
    constructor(props) {
      super(props);
      this.state = {
          ...
          return(
            ...
            <DataTable.Row key={myIndex} style={styles.row}>
                ...
                <DataTable.Cell  style={{flex: 0.5}}>
                  <CellAksiPengumumanMahasiswa navigation={props.navigation} pen_id={myValue.pen_id}/></DataTable.Cell>
            </DataTable.Row>
          )
      });
      return (
